<x-layout>
    ...
    <article class="py-8 max-w-screen-md border-b border-gray-300">
        ...
        <div class="text-base text-gray-500">
            <a href="#">Seniccc</a> | 2 February 2024
        </div>
        <p class="my-4 font-light">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Architecto commodi nobis facilis repellat deserunt, dicta corrupti debitis ex quisquam enim similique ipsa sed soluta minima mollitia quia cupiditate ad excepturi!</p>
        <a href="#" class="font-medium text-blue-500 hover:underline">Read More &raquo;</a>
    </article>
